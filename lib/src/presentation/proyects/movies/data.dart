...
final movies = [
  Movie(
    name: 'Greta ',
    image: 'assets/movies/greta.jpg',
    screenPreview: 'assets/movies/greta.jpg',
    description:
  ...
  Movie(
    ...
    screenPreview: 'assets/movies/aladdin.jpg',
    description:
        'A kind-hearted street urchin and a power-hungry Grand Vizier vie for '
        'a magic lamp that has the power to make their deepest wishses come true.',
    type: 'Fantasy',
  ...
  Movie(
    name: 'Aladdin 2 ',
    image: 'assets/movies/aladdin_2.jpg',
    screenPreview: 'assets/movies/aladdin_2.jpg',
    description:
        'A kind-hearted street urchin and a power-hungry Grand Vizier vie for '
        'a magic lamp that has the power to make their deepest wishses come true.',
    type: 'Fantasy',
